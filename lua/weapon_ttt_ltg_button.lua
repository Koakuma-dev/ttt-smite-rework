...
if SERVER then
    CreateConVar("ttt_smite_ammo", "3", FCVAR_ARCHIVE + FCVAR_REPLICATED, "How much ammo the Smite weapon should have.")
end

SWEP.ConvarSparksVictim = GetConVar("ttt_smite_sparks_victim")
SWEP.ConvarSparksSelf = GetConVar("ttt_smite_sparks_self")

SWEP.ConvarMaxAmmo = GetConVar("ttt_smite_ammo")
